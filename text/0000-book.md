...
<!-- NOTE: pulled from the githbu issue -->
<!-- A amazing onboarding tool, where if you read it front to back you should have a grasp on the following -->

    <!-- the philosophy behind Twizzler. -->
    <!-- an explanation of the terms used (both specific to Twizzler and operating systems as a whole) -->
    <!-- a large portion of the book would be documenting the "primitives", such as objects, security contexts, pager, ..., hbasically what's already in the book but built upon more with examples and links to relevant areas in src code where they are implemented. -->
    <!-- A rundown of where things are located in the codebase, such as libraries, where userspace programs are located, etc. -->
    <!-- How to write a hello world program. -->
    <!-- How to write a program that utilizes some Twizzler libraries, and how to run it. -->
    <!-- how library development works, how making a userspace library and a kernel library are different. -->
    <!-- how kernel development works, why it's different from normal rust development. -->
